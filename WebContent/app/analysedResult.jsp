    ...
    <div data-role="content">
	 ...
	 <div data-role="collapsible"  data-iconpos="right" >
      <h2 ><img src="themes/images/Male-icon.png"   class="ui-li-icon ui-corner-none">&nbsp;&nbsp;
      			...
      			&nbsp;&nbsp;<img src="themes/images/watson.png" width="26px" height="26px" >
      </h2>
      <div>
       <a href="genChart.wss" data-ajax="false" >
       <button type="button" class="ui-btn ui-corner-all ui-btn-a"><img src="themes/images/watson.png" width="64px" height="64px" /><br/>View Cognitive Suggestions</button></a> 
      <p></p>
      </div>
    </div>
...
<div data-role="collapsible"  data-iconpos="right">
    ...
    <ul data-role="listview" data-inset="true">
     	<c:forEach items="${jobDetails.operationsList}" var="item">   
    	  	<li >
      			...
      			<p><b>Document :</b>&nbsp;<a href="./pdf/${ item.taskManual}" data-ajax="false" download="${ item.taskManual}"><c:out value="${ item.taskManual}" /></a></p>
      			</li>
		</c:forEach>
    </ul>
    ...
    <!--  <fieldset class="ui-grid-a">
                    <div class="ui-block-a"><button type="submit" class="ui-btn ui-corner-all ui-btn-a">Skip</button></div>
            </fieldset> -->
      ...
      <button type="submit" class="ui-btn ui-corner-all ui-btn-a">Skip</button>
      </div>
