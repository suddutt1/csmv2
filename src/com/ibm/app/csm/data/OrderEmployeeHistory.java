...
public class OrderEmployeeHistory {

	private ObjectId id;
	private String objType = "ord_emp_hist";
	...
	public OrderEmployeeHistory() {

	}
	public OrderEmployeeHistory(OrderMain ordMain, String opId,EmployeeMaster otherObj)
	{
	...
	/*------Generated code--------------*/
	public static OrderEmployeeHistory parseToObject(DBObject dbObject) {
		if (dbObject != null) {
			OrderEmployeeHistory parsedObject = new OrderEmployeeHistory();
