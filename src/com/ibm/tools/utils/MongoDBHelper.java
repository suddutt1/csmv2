		...
		try {
			if (mongo == null) {
				...
				if (serviceJSON != null) {
					...
					if (thekey == null) {
						LOGGER.log(Level.INFO,
								"|MONGODB_HELPER|Cannot find any MONGOLAB service in the VCAP; Exiting");
					...
					// "mongodb://IbmCloud_shv47j4v_dacamm0v_k4vm1vo6:Qx7-rqjl_HGZgPWrkTWUBDOW8A3Irn-s@ds027708.mongolab.com:27708/IbmCloud_shv47j4v_dacamm0v"
